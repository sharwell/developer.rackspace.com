...
These docs are written in a narrative format with the same use cases across all the SDKs. For an example of documentation that follows this literate flow, check out `Mailgun's documention<http://documentation.mailgun.com/quickstart.html#sending-messages>`_.
